...
type ComplexityRoot struct {
	...
	Query struct {
		Products           func(childComplexity int, count *int) int
...
type EntityResolver interface {
	FindProductByID(ctx context.Context, id int) (*models.Product, error)
}
type QueryResolver interface {
	Products(ctx context.Context, count *int) ([]*models.Product, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Query.products":
		...
		return e.complexity.Query.Products(childComplexity, args["count"].(*int)), true
...
func (ec *executionContext) _Entity_findProductByID(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNProduct2ᚖsubgraphᚋmodelsᚐProduct(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_products(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().Products(rctx, fc.Args["count"].(*int))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	res := resTmp.([]*models.Product)
	fc.Result = res
	return ec.marshalNProduct2ᚕᚖsubgraphᚋmodelsᚐProductᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNProduct2subgraphᚋmodelsᚐProduct(ctx context.Context, sel ast.SelectionSet, v models.Product) graphql.Marshaler {
	return ec._Product(ctx, sel, &v)
}

func (ec *executionContext) marshalNProduct2ᚕᚖsubgraphᚋmodelsᚐProductᚄ(ctx context.Context, sel ast.SelectionSet, v []*models.Product) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNProduct2ᚖsubgraphᚋmodelsᚐProduct(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNProduct2ᚖsubgraphᚋmodelsᚐProduct(ctx context.Context, sel ast.SelectionSet, v *models.Product) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
